...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		// no spring 2 usar saveAll e nao save
		...
		clienteRepository.saveAll(Arrays.asList(cli1)); // salva primeiro o cliente pois nao depende de endereco
		enderecoRepository.saveAll(Arrays.asList(e1, e2));// endereco vem depois pois precisa ter um cliente
